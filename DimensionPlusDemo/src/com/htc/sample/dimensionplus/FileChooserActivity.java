...
public class FileChooserActivity extends ListActivity {
	...
	protected void onListItemClick(ListView l, View v, int position, long id) {
		...
		if (file.isDirectory()) {
			...
			returnToDPActivity(file.getAbsolutePath());
		}
	}
    public void returnToDPActivity(String filename) {
    	final Intent returnIntent = new Intent();
        returnIntent.putExtra(DimensionPlusActivity.EXTRAS_FILE_NAME,filename);
